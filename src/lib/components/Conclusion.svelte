      ...
      <div class="answer-box">
        ...
        <div class="answer-text">
          <p class="conclusion-text">
            <strong>Chimborazo está más cerca del Sol</strong> porque su ubicación cerca del 
            ecuador lo coloca sobre el <strong>abultamiento de la Tierra</strong>, alejándolo 
            del centro del planeta más de lo que su altura podría sugerir.
          </p>
          <p class="conclusion-text">
